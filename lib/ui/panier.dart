              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('${item.pizza.price.toStringAsFixed(2)} €', style: TextStyle(color: Colors.blueGrey)),
                      Row(
                  ...
                  Text('Sous-Total: ${(item.pizza.price * item.quantity).toStringAsFixed(2)} €',  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.blueAccent)),
                ],
              ),
            ),
          ],
